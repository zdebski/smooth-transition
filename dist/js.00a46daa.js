...
},{"process":"node_modules/process/browser.js"}],"node_modules/gsap/TweenLite.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
    ...
    value: function _in(_ref) {
      ...
      tl.fromTo(to, 0.5, {
        ...
        onComplete: function onComplete() {
          from.remove(); //removieng container 
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14129" + '/');
